...
| 1.2.3 | Регистрация аккаунта на платформе для хостинга ML-модели | ✅ | Аккаунт зарегистрирован. |
| 1.2.4 | Создание репозитория модели | ✅ | Репозиторий создан на платформе хостинга. |
...
| # | Задача | Статус | Примечание |
|---|--------|:------:|-------------|
| 3.1.1 | Инициализация Git-репозитория | ✅ | Репозиторий создан, код загружен. |
...
| 6.3.5 | Загрузка финальных весов в репозиторий модели | ❌ | |
...
└── docs/                 # Документация и черновики
    ├── AI_Tutor_Project.pdf       # Техническое задание
